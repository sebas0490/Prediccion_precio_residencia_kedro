...
# prediccion_precio_residencia_kedro documentation build
...
from prediccion_precio_residencia_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "prediccion_precio_residencia_kedro"
author = "Kedro"
...
htmlhelp_basename = "prediccion_precio_residencia_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "prediccion_precio_residencia_kedro.tex",
        "prediccion_precio_residencia_kedro Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "prediccion_precio_residencia_kedro",
        "Project prediccion_precio_residencia_kedro codebase.",
        "Data-Science",
    )
]
