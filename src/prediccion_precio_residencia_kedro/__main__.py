"""prediccion_Precio_residencia_kedro file for ensuring the package is executable
as `prediccion-precio-residencia-kedro` and `python -m prediccion_precio_residencia_kedro`
"""
import importlib
