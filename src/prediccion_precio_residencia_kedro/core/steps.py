...
from prediccion_precio_residencia_kedro.core.variables_globales import columnas_raw

from prediccion_precio_residencia_kedro.data.procesamiento_datos import LimpiezaCalidad, Preprocesamiento, \
    ProcesamientoDatos
...
class Steps:
    ...
    @classmethod
    def build(cls, folder_path: str, url: str = None, logger: Union[None, logging.Logger] = None):
        du = DataUtils(
